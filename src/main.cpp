...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // shitcoin: 1 days
static const int64 nTargetSpacing = 7200; // shitcoin: 2 hour blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1479797687; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1479797687;
            block.nNonce   = 440824;
        }
